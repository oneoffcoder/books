...
This directory contains the Sphinx source for the `Drone Programming with Tello` book.
...
- `source/`: book chapters and supporting assets
- `media/`: supporting media files used by the book
