...
This directory contains the Sphinx source for the `AWS Certified Developer` book.
...
- `source/`: book content, including the `index.rst` table of contents and supporting notebooks
