...
This directory contains the Sphinx source for the `Scratch` book.
...
- `source/`: Scratch book chapters and static images
- `media/`: supporting media files
- `list-images.py`: helper script for image inventory work
