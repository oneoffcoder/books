...
IMAGE="${IMAGE:-book-r-intro-check:local}"
SOURCE_DIR="${SOURCE_DIR:-${REPO_ROOT}/sphinx/r-intro/source}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/sphinx/r-intro/build/executed-notebooks}"
